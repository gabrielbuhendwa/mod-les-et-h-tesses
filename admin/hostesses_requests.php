<?php 
    require('../controllers/hostesses_requestsControllers.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="header">
        <h2>Requêtes Hôtesses (<?= htmlspecialchars($total_requests) ?>)</h2>
    ...
    <div class="table-container">
        <table class="orders-table">
            ...
            <tbody id="search-results">
                <?php foreach ($hostesses_requests as $request): ?>
                    <tr>
                        <td>
                        ...
                        <td><?= htmlspecialchars(date("F j, Y", strtotime($request['request_date']))) ?></td>
                        <td>
                            <a href="hostesses_requests_details.php?id=<?= htmlspecialchars($request['id']) ?>" class="action-btn view-details">Voir en détails</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
