<?php 
    require('../controllers/models_requestsController.php');
...
<body>
    ...
    <div class="header">
        <h2>Requêtes Modèles (<?= htmlspecialchars($total_requests) ?>)</h2>
    ...
    <div class="table-container">
        <table class="orders-table">
            ...
            <tbody id="search-results">
                <?php foreach ($models_requests as $request): ?>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="models_requests_details.php?id=<?= htmlspecialchars($request['id']) ?>" class="action-btn view-details">Voir en détails</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
