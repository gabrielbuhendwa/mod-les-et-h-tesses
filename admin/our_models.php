...
<body>
    ...
    <div class="header">
        <h2>Nos Modèles (<?= htmlspecialchars($total_models) ?>)</h2>
            ...
            <tbody id="search-results">
                <?php foreach ($models as $request): ?>
                    <tr>
                        ...
                        <td>
                            <a href="model_details.php?id=<?= htmlspecialchars($request['id']) ?>" class="action-btn view-details">Voir en détails</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
